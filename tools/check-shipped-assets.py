#!/usr/bin/env python3
"""Every non-Cargo file pdfce REDISTRIBUTES must have its licence recorded.
...
and — imminently — OCR model weights are files pdfce ships inside its portable
folder, so they are redistributed by pdfce and carry whatever obligations
    ...
    for directory in asset_dirs:
        ...
        if not prov.is_file():
            problems.append(
                ...
                f"      cargo-about cannot see these — if pdfce redistributes them,\n"
        ...
        if not _LICENCE_RE.search(text):
            problems.append(
                ...
                f"      came from does not say what may be done with it, and pdfce\n"
