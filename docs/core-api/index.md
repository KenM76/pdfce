...
| file | covers | size |
|---|---|---|
| [`01-reading-and-model.md`](01-reading-and-model.md) | loading, the COS object model, pages, content streams, text extraction, fonts, vector picking/snapping, filters, colour, navigation, metadata | 2,656 lines · 143 clauses cited |
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 178 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 110 variants | 4,086 lines · 100 clauses cited |
