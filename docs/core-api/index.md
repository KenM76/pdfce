...
| file | covers | size |
|---|---|---|
| [`01-reading-and-model.md`](01-reading-and-model.md) | loading, the COS object model, pages, content streams, text extraction, fonts, vector picking/snapping, filters, colour, navigation, metadata | 2,649 lines · 143 clauses cited |
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 151 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 90 variants | 2,999 lines · 73 clauses cited |
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, OCR, print/imposition, rasterising — each with **★ what the UI must disclose** | 2,533 lines · 59 clauses cited |
