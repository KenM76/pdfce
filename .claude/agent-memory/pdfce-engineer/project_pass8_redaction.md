...
- Image intersecting region → REFUSE by name (RedactError::ImageRegion). Form XObject intersecting → disclose (not surgically redacted). Never overlay-and-leave-pixels.
