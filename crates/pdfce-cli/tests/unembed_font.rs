//! # `pdfce-cli unembed-font` integration tests
//!
//! Black-box tests over the **real binary** for the first destructive font
//! operation (Pass 67.0 phase B). `pdfce_core::font_unembed`'s own unit
...
fn temp_out(name: &str) -> PathBuf {
    let dir = std::env::temp_dir().join("pdfce-unembed-tests");
