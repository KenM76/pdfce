//! # `pdfce-cli rotate-annotation` — black-box over the real binary
//!
...
//!
//! The core suite (`crates/pdfce-core/tests/annot_rotate.rs`) covers the
...
/// resolve it.
///
/// pdfce deliberately does **not** snap a near-integer result back: a snap
