...
//!
//! The second is what this file covers: the postures pdfce already had are
...
//!   pdfce's unconditional behaviour and the operator asked for it to remain
...
fn temp_out(name: &str) -> PathBuf {
    let dir = std::env::temp_dir().join("pdfce-style-policy-tests");
...
/// **`refuse` keeps pdfce's prior behaviour, verbatim.**
///
...
/// silence would understate what pdfce had chosen on the operator's behalf.
#[test]
