//! # `dimension-add --kind two-lines` — pdfce decides which dimension
//!
...
//!
//! The DECISION, not the drawing. `pdfce-core`'s own unit tests pin the
...
fn temp_out(name: &str) -> PathBuf {
    let dir = std::env::temp_dir().join("pdfce-two-line-tests");
