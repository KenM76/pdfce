...
//!
//! pdfce folds a soft mask into the clip by multiplication. That is a sound way
...
fn render(name: &str) -> (Vec<u8>, usize) {
    ...
    let out = pdfce_render::render_page(&doc, &pages[0], 1.0).expect("render must succeed");
