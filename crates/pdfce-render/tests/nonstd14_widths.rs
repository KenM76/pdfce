...
//! one of the fourteen standard names, so pdfce's width ladder —
...
//! out correctly — both alias Arial to Helvetica. pdfce's only
//! disclosure was `substituted=1`, which says the SHAPES are pdfce's and
