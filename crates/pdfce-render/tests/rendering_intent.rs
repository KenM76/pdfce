...
//!
//! pdfce parsed `ri` and threw the value away — a recognised no-op — until this
...
//! Not asserted: any pixel. pdfce carries the intent and does not yet act on
...
fn the_four_names_resolve_and_an_unknown_one_falls_back() {
    use pdfce_core::color::RenderingIntent as R;
    assert_eq!(
