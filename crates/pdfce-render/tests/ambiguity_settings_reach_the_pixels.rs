...
//! `crates/pdfce-render/tests/cmyk_intent.rs` has to `cmyk_intent`.
//!
...
//!
//! `AS-A1` (missing `/AS`) is proved in `pdfce-core`'s own
...
use pdfce_core::settings::{CmykJpegPolarity, MaskResample, MinifyFilter};
