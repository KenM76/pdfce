...
//!
//! `crates/pdfce-render/src/type3.rs` unit-tests the pieces that are pure
...
//! A blue, C red, D blue. So pdfce follows §9.6.5 here **knowing** the
...
/// shortfall, but it is still pdfce doing something the file's bytes did
...
///
/// 64 is [`pdfce_render::interpret::MAX_XOBJECT_DEPTH`], shared with
...
fn a_self_recursive_glyph_is_bounded_and_still_draws() {
    ...
    assert_eq!(
        ...
        pdfce_render::interpret::MAX_XOBJECT_DEPTH,
