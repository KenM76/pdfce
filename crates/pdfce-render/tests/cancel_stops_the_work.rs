...
use pdfce_render::tiny_skia::{self, Pixmap};
use pdfce_render::{RenderError, RenderOptions, interpret, render_page_with_view};
...
fn a_cancelled_render_paints_nothing() {
    ...
    let (w, h, base_ctm) = pdfce_render::page_device_geometry(page, 1.0);
