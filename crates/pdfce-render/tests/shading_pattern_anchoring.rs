...
/// pdfce correctly refuses to parse, and the test then measures the
...
fn a_tiling_pattern_is_counted_not_silently_skipped() {
    ...
    let bytes = build(&[
        ...
        (
            ...
            // measure pdfce's refusal of the fixture rather than its
...
fn a_pattern_does_not_survive_into_a_non_painting_space() {
    ...
    // inside `[ ]`, producing an array holding one dict. pdfce correctly
