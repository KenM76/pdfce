...
//! difference, and reasonably concludes pdfce is broken rather than that
...
//! — `pdfce-core::color`'s module docs already state that a filled
...
//! renders, and pdfce's default follows the reference. Under
...
fn an_image_sample_honours_the_same_intent_as_the_k_operator() {
    ...
    for intent in [
        ...
        // testing tiny-skia's rounding, not pdfce's colour.
