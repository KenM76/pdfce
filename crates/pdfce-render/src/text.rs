...
//!   Shapes are pdfce's plausible ones; positions are exact (they come
...
pub struct LoadedFont {
    ...
    /// pdfce's plausible shape from their own deliberately-supplied one.
...
impl LoadedFont {
    ...
    /// is a single 2-byte range). pdfce consumes it as a high byte with
...
fn substitute_face(
    ...
    // (3) the bundled Base-14 floor — pdfce's own plausible shape.
