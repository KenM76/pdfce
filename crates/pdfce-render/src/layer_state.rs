...
//! property of the *file*, and [`pdfce_core::annot::optional_content_default_off`]
...
//!
//! # Relationship to `pdfce_core::layers`
//!
//! `pdfce-core`'s `layers` module ENUMERATES what a document declares —
