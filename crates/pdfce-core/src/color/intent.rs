...
//!
//! pdfce **parsed the `ri` operator and threw the value away** — a recognised
...
//! of the four does not exist in any standard.** So pdfce's job is to carry the
...
//!
//! That is pdfce's own CMYK→sRGB *back*-conversion policy
//! (`Calibrated`/`NeutralBlack`). It is a display choice about a table pdfce
...
impl RenderingIntent {
    ...
    ///
    /// `AbsColorimetric` is deliberately NOT produced: it is a typo pdfce
