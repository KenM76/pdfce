...
//!
//! Two very different subsystems in `pdfce-core` need to pack a stream of
...
//! no line-breaking algorithm, so pdfce is matching no documented
...
///
/// ```
/// use pdfce_core::linebreak::greedy_pack;
///
