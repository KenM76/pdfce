...
//!
//! **Detection only.** pdfce does not write linearized files, and this
...
//!
//! ## Why pdfce detects something it cannot produce
//!
...
/// Web View property, so pdfce has nothing left to warn about.
...
///
/// ```
/// use pdfce_core::linearization::{detect, Linearization};
///
...
/// the leading-junk case pdfce's header probe already allows.
...
mod tests {
    ...
    fn dictionary_beyond_the_1024_byte_window_is_not_detected() {
        ...
        // does not fit in the first 1024 bytes is not one, and pdfce
