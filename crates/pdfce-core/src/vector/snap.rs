...
//!
//! Everything here is `pdfce-core`, with **no GUI/windowing dependency**
...
//! `cargo tree -p pdfce-core` stays egui/eframe/winit/wgpu/glow-free
//! (`docs/ARCHITECTURE.md` §3).
//!
//! ## The seven-level fixed priority — a DELIBERATE simplification (R61)
//!
//! Decision 011 §2.2 commits pdfce to a **fixed** high→low priority list of
...
//! two-tier precedence concept"). pdfce chooses the simpler fixed list on
...
//! screen"). pdfce mirrors that precedent exactly ([`SnapConfig::intersections`]
...
///
/// ```
/// use pdfce_core::vector::{AxisConstraint, Point, constrained_second_point};
