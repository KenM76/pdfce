...
pub use decompose::{
    ...
    NoXObjects, PageObjects, PaintStyle, PathObject, RunPositioning, Segment, Subpath,
    TextBoundsBasis, TextFont, TextObject, TextPreview, TextRun, TokenRange, VectorObject,
...
pub use hit::{
    FLATTEN_STEPS, HitTarget, MarqueeMode, hit_test_point, hit_test_point_all, hit_test_point_deep,
    hit_test_rect, hit_test_subpaths, hit_test_text_runs, subpath_bounds,
};
pub use snap::{
