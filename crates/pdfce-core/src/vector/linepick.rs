...
//!
//! Every ce-dimension pick model in pdfce up to now has been *point*-based:
...
///
/// pdfce's standing rule for exactly this situation (R169) is that a choice
...
pub struct ParallelPolicy {
    ...
    /// the operator's favour: pdfce's inference is visible and rejectable,
...
pub enum TwoLineRelation {
    ...
    /// is unverified, so pdfce declines rather than inventing one.
    Collinear,
