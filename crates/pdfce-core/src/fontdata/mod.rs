...
//!   product decision that lives in `pdfce-render::font::select`, NOT
//!   here.
//!
...
impl Std14 {
    ...
    ///
    /// ```
    /// use pdfce_core::fontdata::{Std14, std14_base_font_name};
    ///
...
/// decision that lives in `pdfce-render::font::select`, deliberately not
...
///
/// ```
/// use pdfce_core::fontdata::{std14_by_base_font, Std14};
///
...
///
/// ```
/// use pdfce_core::fontdata::{std14_base_font_name, std14_by_base_font, Std14};
///
...
///
/// ```
/// use pdfce_core::fontdata::{std14_width, Std14};
///
...
/// (§9.6.2.2 permits it); this struct is for when pdfce must *write* a
...
///
/// ```
/// use pdfce_core::fontdata::{std14_descriptor, Std14};
///
...
///
/// ```
/// use pdfce_core::fontdata::{encoding_glyph_name, BaseEncoding};
///
...
///
/// ```
/// use pdfce_core::fontdata::glyph_name_to_unicode;
///
...
/// rather than as pdfce's counted glyph-name extension, and only for a
/// name that is a genuine Adobe Latin glyph name either way.
///
/// # Examples
///
/// ```
/// use pdfce_core::fontdata::is_standard_latin_or_symbol_name;
///
...
/// pdfce from doing quietly.
///
/// # Examples
///
/// ```
/// use pdfce_core::fontdata::glyph_name_to_unicode_string;
///
...
///
/// ```
/// use pdfce_core::fontdata::{std14_builtin_encoding, BaseEncoding, Std14};
///
...
mod tests {
    ...
    fn base_font_rejects_aliases_and_near_misses() {
        for bad in [
            ...
            "Arial",     // aliasing lives in pdfce-render, not here
            "CourierNew",
            "Helv",
            "",
        ] {
