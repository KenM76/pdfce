...
///
/// ```
/// use pdfce_core::crypto::aes::{decrypt_cbc_256, MIN_CIPHERTEXT_LEN};
///
...
///
/// ```
/// use pdfce_core::crypto::aes::decrypt_cbc_256;
...
///
/// ```
/// use pdfce_core::crypto::aes::unwrap_key_cbc_256;
///
...
///
/// ```
/// use pdfce_core::crypto::aes::decrypt_ecb_256_block;
///
/// let file_key = [
///     0x9c, 0x41, 0xcb, 0x1c, 0x02, 0x13, 0x80, 0x48, 0x96, 0x0d, 0x57, 0xf4,
///     0x8a, 0x21, 0x22, 0xf8, 0xfe, 0xbf, 0x4a, 0x68, 0xdd, 0x03, 0x18, 0x62,
...
mod tests {
    ...
    /// gate; this is.)
    ///
    /// [`crypto_decrypt` fuzz target]: https://github.com/KenM76/pdfce
    #[test]
