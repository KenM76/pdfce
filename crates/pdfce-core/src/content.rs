...
//! wrong for editing (001 §5.3). pdfce's model answers the question an
...
//! `pdfce-render`. Per §7.8.2 the syntax is the standard §7.2 lexer —
...
/// Operand container nesting bound (pdfce policy, ARCHITECTURE.md
