...
//!
//! Two obligations follow, and pdfce honoured neither before this module
//! existed:
//!
...
//! splitting and merging** — four operations pdfce ships — silently
...
/// What pdfce does when a structural page operation would split a
...
impl SeparationDict {
    ...
    ///
    /// Such a page is already non-conforming; pdfce counts it and leaves
