...
//! carried' until verified empirically"*, and then recommends pdfce
//! decide for itself:
//!
...
//!
//! pdfce adopts that recommendation. It is a **documented pdfce
...
//! one.** pdfce does not carry the `/Dests` name tree into an assembled
...
/// Maximum outline nesting rebuilt (pdfce policy, `ARCHITECTURE.md` §10).
