...
//! claim pdfce discloses rather than carries.
//!
//! ## The two traps
//!
...
/// # Errors
///
/// See [`ImageImportError`]. Every compression method and bit depth pdfce
...
/// Map a `biCompression` value pdfce declines to its stable feature key.
///
