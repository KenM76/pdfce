...
//!
//! Until this module existed, `pdfce_core::ocr` had **zero consumers anywhere
...
//!
//! **OCR is the single largest inference pdfce makes: every word here is a
...
/// drops the report has made pdfce silent about a page of guesses.
...
pub struct OcrLayerReport {
    ...
    /// sliver) rather than a pdfce fault, which is exactly why it is reported:
...
/// use pdfce_core::ocr::{OcrPage, layer};
///
