...
//! model that underpins pdfce's round-trip invariant. Spec sources are
...
//! not by default.
//!
//! ## Resource guards (ARCHITECTURE.md §10.1 — pdfce policy, not spec)
//!
...
///
/// pdfce policy, not a spec value: Annex C's 127-byte name limit is
...
/// corpus file pdfce mishandled. Raised to 1 MiB: still a hard bound
...
///
/// pdfce policy, not a spec value: Annex C's 32,767-byte limit applies
...
///
/// ```
/// use pdfce_core::lexer::{Lexer, TokenKind};
///
