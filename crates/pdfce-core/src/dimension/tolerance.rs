...
//! and this follows it.
//!
//! ## Honest naming: pdfce draws SolidWorks-STYLE tolerance notation
//!
...
//! | `swTolBLOCK`, `swTolGeneral` | Resolve against a document-level block-tolerance table / an ISO 2768 class table (§A.4). Both need a table pdfce does not have; a "general tolerance" that resolves to nothing would print a promise the file cannot keep. |
...
impl Tolerance {
    ...
    ///
    /// ```
    /// use pdfce_core::dimension::{NumberFormat, Tolerance, Unit};
    ///
