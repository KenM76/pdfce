...
//!
//! It was written twice-shaped and shipped once: `pdfce-cli`'s
...
//!
//! Everything here is an inference — pdfce reading geometry and deciding what
...
/// Why pdfce declined to author a ce dimension from a pair of picked lines.
///
...
///
/// This is the single implementation behind both `pdfce-cli`'s
...
/// # Ok::<(), pdfce_core::dimension::TwoLineRefusal>(())
/// ```
