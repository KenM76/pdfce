...
//!
//! This is the **only** object representation in pdfce-core: the parse
...
/// A dictionary (§7.3.7): name-keyed, unordered per spec — but pdfce
...
impl Dict {
    ...
    /// operator never asked for, and a later reader cannot tell "pdfce
...
///
/// ```
/// use pdfce_core::object::{equivalent_across_buffers, Dict, Name, Object, Stream};
...
///
/// §5's contract — "an object pdfce did not logically modify re-emits
