...
//!
//! pdfce could parse, render, edit and save a PDF, and it could not **show an
...
/// caller is exempt from `#[non_exhaustive]` — and `pdfce-cli` could not,
/// because it is a different crate and feels the attribute the way `pdfceGUI`
