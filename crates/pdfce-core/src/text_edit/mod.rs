...
//!
//! Pass 14.0 of pdfce (`docs/decisions/014-acrobat-text-editing.md` §5.2's
...
//!
//! This module lives in `pdfce-core` and introduces **no** GUI/windowing
...
//! `pdfce-gui` canvas edit tool and the `pdfce-cli inspect --text-blocks`
