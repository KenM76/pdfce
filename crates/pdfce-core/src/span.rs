...
//! decision in pdfce: **provenance is a first-class field, not an
...
//!
//! This is what makes pdfce's editing signature-safe: an incremental save
...
impl ByteSpan {
    ...
    /// (`pdfce-core`'s crate-level panic-free policy), so it degrades to
