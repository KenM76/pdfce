...
//! different question: **which field, computed how, from what, and can pdfce
...
//! and pdfce could not read it" is a fact an operator needs; silence would
//! read as "no script".
//!
//! # Traversal
//!
...
/// script pdfce could not read is not a script pdfce found nothing in.
...
pub enum ScriptSource {
    ...
    /// text pdfce never saw cannot possibly be a recognised built-in. This
...
impl FieldScript {
    /// Whether pdfce can natively reproduce this script's effect.
    #[must_use]
...
impl ScriptInventory {
    /// The scripts pdfce could natively reproduce.
