//! # export — pdfce's document model written to formats other than PDF
//!
//! Everything under here is a WRITE path out of pdfce's own model into a
...
//! pdfce did not change, and they have no meaning when the output is not a
//! PDF at all.
//!
//! Same GUI-core separation as the rest of `pdfce-core`: no windowing
