...
//! predictors apply **verbatim** and pdfce reuses that code unchanged. The
...
//! test is the reason pdfce will not acquire it by accident.
//!
...
use pdfce_core::{filters, page_tree};
