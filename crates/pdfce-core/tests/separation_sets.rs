...
//! of a set and not others falsifies every survivor, and pdfce shipped
...
fn pages_of(doc: &Document) -> Vec<ObjId> {
    pdfce_core::page_tree::pages(doc)
...
fn extract_can_refuse_to_split_a_set() {
    use pdfce_core::pageops::{AssembleOptions, PageOpError, assemble};
