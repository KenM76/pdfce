...
//! whole new PDF, which made recognition the one capability in pdfce that was
...
use pdfce_core::edit::{CommandKind, EditSession, OcrPageLayer};
use pdfce_core::ocr::layer::{OcrLayerError, OcrLayerOptions};
...
fn session_ocr_sees_an_edit_made_earlier_in_the_session() {
    ...
    let req = pdfce_core::text_edit::AddTextRequest::new(0, (72.0, 600.0), "EDITED-FIRST");
