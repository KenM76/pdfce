...
//! ([`pdfce_core::outline`], ISO 32000-1 §12.3.3 / §12.3.2).
//!
...
/// are the point. `pdfce-core` denies `unwrap`/`expect`/`panic`/
...
fn both_named_destination_namespaces_resolve() {
    ...
    //    resolves — pdfce searches both namespaces — and the leniency is
