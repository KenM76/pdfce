...
//!
//! That was survivable while pdfce only READ forms: a reader that mishandles
...
use pdfce_core::forms::{self, FieldType};
...
///
/// Field CREATION is refused there (decision 020 §3.2.2) because pdfce can
...
/// a real form, and refusing it would refuse a capability pdfce has.
#[test]
...
/// `/AcroForm`, so this was reachable from the very first flatten pdfce ever
/// performed.
#[test]
