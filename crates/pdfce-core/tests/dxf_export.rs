...
//! `C:\personal_rag\dxf\`, which cost the operator real time before pdfce
//! existed:
//!
...
fn export(src: &[u8], opts: &DxfOptions) -> (String, pdfce_core::export::dxf::DxfOutcome) {
...
fn an_empty_page_still_produces_a_loadable_file() {
    ...
    assert_eq!(out, pdfce_core::export::dxf::DxfOutcome::default());
