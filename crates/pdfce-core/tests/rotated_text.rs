...
//! ## What was wrong
//!
//! [`ExtractedGlyph`](pdfce_core::text_extract::ExtractedGlyph) published the
...
use pdfce_core::text_extract::{self, ExtractOptions, ExtractedText};
...
fn probe(g: &pdfce_core::text_extract::ExtractedGlyph) -> (f64, f64) {
...
/// [`TextRun::direction`](pdfce_core::text_extract::TextRun::direction)
...
/// the guarantee
/// [`TextRun::direction`](pdfce_core::text_extract::TextRun::direction) is
...
///
/// [`EditableTextModel::hit_test`](pdfce_core::text_edit::EditableTextModel::hit_test)
