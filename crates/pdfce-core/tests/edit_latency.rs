...
//!
//! ```text
//! cargo test -p pdfce-core --release --test edit_latency -- --ignored --nocapture
//! ```
//!
//! ## Why this exists in `pdfce` and not only in the shell
//!
//! `pdfceGUI` measured this first and reported it (2026-08-30) as a boundary
...
use pdfce_core::vector::{Matrix, decompose_page};
...
fn decompose(session: &EditSession) -> pdfce_core::vector::PageObjects {
