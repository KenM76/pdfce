...
//!
//! * **A foreign appearance rotates correctly.** pdfce composes a rotation
...
/// ★ The claim that makes this verb work on artwork pdfce did not draw.
///
...
/// result, so pdfce leaves them and says so rather than inventing values.
#[test]
