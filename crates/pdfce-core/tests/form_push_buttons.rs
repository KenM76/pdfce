...
//! three `/FT /Btn` kinds pdfce could not create.
//!
...
use pdfce_core::edit::{EditError, EditSession, NewCheckBox, NewPushButton, NewTextField};
...
fn dict_of(s: &EditSession, id: pdfce_core::object::ObjId) -> Dict {
    s.graph()
        .resolved(id)
        .as_dict()
        .expect("a dictionary")
...
/// pdfce-authored document could contain a push button to refuse.
#[test]
