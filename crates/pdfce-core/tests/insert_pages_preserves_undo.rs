...
//! [`pdfce_core::pageops::insert`].
//!
//! # Why this file exists
//!
//! The `pdfceGUI` session declined to wire "insert from file" and said why:
//!
...
fn the_saved_file_carries_the_inserted_page_and_reloads() {
    ...
    let slots = pdfce_core::page_tree::page_slots(&reloaded).expect("the reloaded page tree walks");
    assert_eq!(
        slots.len(),
        3,
