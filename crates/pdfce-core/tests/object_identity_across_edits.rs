...
use pdfce_core::vector::{Matrix, decompose_page, remap_index_after_delete};
    ...
    model
        ...
        .map(|o| {
            ...
            format!(
                "{}:{:.2},{:.2},{:.2},{:.2}",
                match o {
                    pdfce_core::vector::VectorObject::Path(_) => "path",
                    pdfce_core::vector::VectorObject::Text(_) => "text",
                    _ => "other",
                },
                b.min.x,
                b.min.y,
