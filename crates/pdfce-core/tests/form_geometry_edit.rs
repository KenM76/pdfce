...
//! it silently.
//!
//! So the reach existed and the write did not. `pdfceGUI` measured the cost on
//! real drawings:
//!
...
//! many times. So an edit inside one changes every place it appears, and pdfce
...
use pdfce_core::vector::{Bounds, Point, VectorObject};
...
/// is no longer a box, and pdfce says so. That sentence is generated deep
