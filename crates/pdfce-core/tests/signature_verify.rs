//! # `signature::verify` against signatures pdfce did not produce
//!
...
//! pdfce's was written, so agreement here is two implementations of the
//! same clauses agreeing, not pdfce agreeing with itself.
//!
